 ...
 *
 * vtkPolygon_81 is a concrete implementation of vtkCell to represent a 2D
...
#ifndef vtkPolygon_81_h
#define vtkPolygon_81_h
...
class VTKCOMMONDATAMODEL_EXPORT vtkPolygon_81 : public vtkCell
{
public:
  static vtkPolygon_81 *New();
  vtkTypeMacro(vtkPolygon_81,vtkCell);
   ...
   * with the appropriate parameters from the instantiated vtkPolygon_81.
   */
  double ComputeArea();
   ...
   * If you already have a vtkPolygon_81 instantiated, a convenience function,
...
private:
  vtkPolygon_81(const vtkPolygon_81&) = delete;
  void operator=(const vtkPolygon_81&) = delete;
};
